<template>
    <div>
        ...
        <div v-if="!GET_IS_LOGGED_IN">
            <el-button class="authButton" @click.prevent="firebaseGrantAccess">
            ...
            <el-button class="authButton" @click.prevent="goToRegister">
                Register
            </el-button>
        </div>
    </div>
...
<script lang="ts">
    ...
    export default defineComponent({
        ...
        methods: {
            ...
            async firebaseGrantAccess(): Promise<void> {
                await firebase
                .auth()
                ...
                .then(async (result) => {
                    ...
                    if (user.userId == null) {
                        this.$router.push('/Register');
                        ElMessage({
                            message: 'Complete registration process with a username!',
                            type: 'info'
                        });
                        return;
                    }
