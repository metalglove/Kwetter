<template>
    ...
    <div v-show="!GET_IS_LOGGED_IN">
        <el-button class="authButton" @click.prevent="loginWithGoogle">
    ...
    export default defineComponent({
        ...
        methods: {
            ...
            async loginWithGoogle() {
                const loginResponse: LoginResponse = await this.$gapi.login();
                const user: User = toUser(loginResponse.currentUser);
