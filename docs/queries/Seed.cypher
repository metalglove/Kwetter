// Create users
CREATE 
(:User {id:'abfc1edc-8b2e-4351-8e55-a0daf0d60d46',userDisplayName:'SuperMario'})
-[:DESCRIBED_BY]->
...
// Follows
MATCH (a:User), (b:User) WHERE (a.id = 'abfc1edc-8b2e-4351-8e55-a0daf0d60d46' AND b.id = '2ea3a292-f6e4-40d7-98c0-fa721cfae443') CREATE (a)-[:FOLLOWS {followedDateTime: '2021-04-25 21:45:40Z'}]->(b);
MATCH (a:User), (b:User) WHERE (a.id = 'abfc1edc-8b2e-4351-8e55-a0daf0d60d46' AND b.id = 'f89c35de-fb43-4fb4-848d-68c8b625ca38') CREATE (a)-[:FOLLOWS {followedDateTime: '2021-04-25 21:45:40Z'}]->(b);
MATCH (a:User), (b:User) WHERE (a.id = '2ea3a292-f6e4-40d7-98c0-fa721cfae443' AND b.id = 'abfc1edc-8b2e-4351-8e55-a0daf0d60d46') CREATE (a)-[:FOLLOWS {followedDateTime: '2021-04-25 21:45:40Z'}]->(b);

// Kweets
MATCH (a:User) WHERE (a.id = 'abfc1edc-8b2e-4351-8e55-a0daf0d60d46') CREATE (a)<-[:KWEETED_BY]-(:Kweet {id:'b3a84788-dda1-495a-a30f-0e7e35e04c37', message:'Hello Kwetter1!',createdDateTime:'2021-04-25 21:45:40Z'});
MATCH (a:User) WHERE (a.id = 'abfc1edc-8b2e-4351-8e55-a0daf0d60d46') CREATE (a)<-[:KWEETED_BY]-(:Kweet {id:'cf711301-6430-4a2b-addd-8ab547e51127', message:'Hello Kwetter2!',createdDateTime:'2021-04-25 21:46:40Z'});
MATCH (a:User) WHERE (a.id = 'abfc1edc-8b2e-4351-8e55-a0daf0d60d46') CREATE (a)<-[:KWEETED_BY]-(:Kweet {id:'cc711301-6430-4a2b-addd-8ab547e51127', message:'Kwetterwette rHelloKwette rHelloKwetter HelloKwetterHe lloKwetterHel loKwetterHelloKwe tterHelloKwetter HelloKwetter Hello!!',createdDateTime:'2021-04-25 21:46:40Z'});
...
// Kweet likes
MATCH (a:User), (b:Kweet) WHERE (a.id = 'abfc1edc-8b2e-4351-8e55-a0daf0d60d46' AND b.id = 'b3a84788-dda1-495a-a30f-0e7e35e04c37') CREATE (a)<-[:LIKED_BY {id: '9e4d277d-cdc5-4b4a-82a3-9c3cf6e6e32f', likedDateTime: '2021-04-25 21:47:40Z'}]-(b);
